...
export class EventStorePublisher implements OnApplicationBootstrap, IEventPublisher {
    ...
    publish<T extends IEvent = IEvent>(
        ...
        const serializeEvent = this.eventSerializer.serialize(event, dispatcher)
        return this.eventStore.persist(serializeEvent);
    }
    ...
    publishAll<T extends IEvent = IEvent>(
        ...
        return this.eventStore.persist(serializeEvents);
    }
}